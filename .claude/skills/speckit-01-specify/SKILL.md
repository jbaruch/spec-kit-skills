...
bash .claude/skills/speckit-core/scripts/bash/create-new-feature.sh --json "$ARGUMENTS" --short-name "your-short-name"

# Without branch creation (if user declined):
bash .claude/skills/speckit-core/scripts/bash/create-new-feature.sh --json --skip-branch "$ARGUMENTS" --short-name "your-short-name"
```
...
Read [spec-template.md](.claude/skills/speckit-core/templates/spec-template.md) to understand required sections.
